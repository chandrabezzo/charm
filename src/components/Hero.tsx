        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-emerald-100 text-emerald-700 px-4 py-2 rounded-full text-sm font-medium">
              ...
              <span>Elevate Your WhatsApp Commerce</span>
            </div>
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Complete WhatsApp Business management platform with Meta Ads integration.
              Manage catalogs, accept payments, and grow your business—all from one powerful dashboard.
            </p>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-3 bg-emerald-50 p-4 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-600">Business Profile Active</div>
                  </div>
