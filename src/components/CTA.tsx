            ...
            <div className="grid lg:grid-cols-2">
              <div className="p-12 lg:p-16">
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Join thousands of businesses using CHARM to scale their WhatsApp commerce operations.
                </p>
              ...
              <div className="bg-gradient-to-br from-emerald-600 to-blue-600 p-12 lg:p-16 text-white flex items-center">
                <div className="space-y-8">
                  <div>
                    ...
                    <div className="text-emerald-100 text-lg">Active businesses worldwide</div>
                  </div>
                  <div className="border-t border-white/20 pt-8">
                    <div className="text-5xl font-bold mb-2">$50M+</div>
                    <div className="text-emerald-100 text-lg">Monthly transactions processed</div>
                  </div>
                  <div className="border-t border-white/20 pt-8">
                    <div className="text-5xl font-bold mb-2">4.9/5</div>
                    <div className="text-emerald-100 text-lg">Average customer rating</div>
                  </div>

                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 mt-8">
                    <p className="text-sm leading-relaxed">
                      "CHARM has completely transformed how we manage our WhatsApp business. Sales increased by 250% in just 3 months!"
                    </p>
                    <div className="mt-4 flex items-center space-x-3">
                      <div className="w-10 h-10 bg-white/20 rounded-full"></div>
                      <div>
                        <div className="font-semibold text-sm">Sarah Johnson</div>
                        <div className="text-emerald-100 text-xs">CEO, Fashion Boutique</div>
                      </div>
                    </div>
                  </div>
                </div>
